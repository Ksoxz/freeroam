            ...
            propertyData.push(
                {
                    ...
                    x: -158,
                    y: -605,
                    img: 'https://26.54.235.4/client/images/mmenu/office.jpg'
                },
            )
        }
            ...
            propertyData.push(
                {
                    ...
                    x: data.get('x'),
                    y: data.get('y'),
                    img: 'https://26.54.235.4/client/images/mmenu/stock.jpg'
                },
            )
        }
            ...
            propertyData.push(
                {
                    ...
                    x: data.get('x'),
                    y: data.get('y'),
                    img: 'https://26.54.235.4/client/images/mmenu/condo.jpg'
                },
            )
        }
            ...
            propertyData.push(
                {
                    ...
                    x: data.get('x'),
                    y: data.get('y'),
                    img: 'https://26.54.235.4/client/images/mmenu/yacht.jpg'
                },
            )
        }
